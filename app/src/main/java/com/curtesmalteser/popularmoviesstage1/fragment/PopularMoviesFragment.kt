...
class PopularMoviesFragment : Fragment(), MoviesAdapter.ListItemClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_movies_layout, container, false)
        ...
        if (savedInstanceState == null) {
            ...
            mRecyclerView.layoutManager?.onRestoreInstanceState(stateRecyclerView)
        }
        moviesAdapter = MoviesAdapter(context, mMoviesList, this)
        mRecyclerView.adapter = moviesAdapter
        mRecyclerView.addOnScrollListener(object : EndlessScrollListener(layoutManager) {
